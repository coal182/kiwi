<%-- 
    Document   : entrylist
    Created on : 15-feb-2012, 13:42:26
    Author     : aula1-15
--%>
...
<html>
    ...
    <body>
		...
		<div id="bar">
            ...
            <%
            List<Entry> entrylist = (List<Entry>)session.getAttribute("entrylistback");
                if(entrylist==null){
             %>
             <jsp:forward page='controller'>
                 <jsp:param name='action' value='chargeentrieslist' />
             </jsp:forward>;
             <%
                }else{
        ...
        out.println("<tr><td>"+e.getTitle()+
        "</td><td id='buttons'><a href='controller?action=deleteentry&identry="+identry+"' id='deleteentry'></a>"+
                "<a href='controller?action=editentry&identry="+identry+"' id='editentry'></a></td></tr>");
               }
                       }
                    %>
        </table>		
