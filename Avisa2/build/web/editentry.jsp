<%-- 
    Document   : editentry
    Created on : 16-feb-2012, 10:00:49
    Author     : aula1-15
--%>
    ...
    <body>
		...
		<div id="content">
			...
			<label for="entrytitle">Entry Title</label>
                        <input type="hidden" name="identry" value="<%int entryid=(Integer)session.getAttribute("editentryid");out.print(entryid);%>" />
                        <input id="entrytitle" name="entrytitle" type="text" size="40" value="<%
                        String entrytitle=(String)session.getAttribute("editentrytitle");
                        out.println(entrytitle);
                        %>" />
                       
                    <br />
                        <textarea id="elm4" name="elm4" rows="15" cols="80" style="width: 400px; height: 400px;">
                        <%
                        String entrycontent=(String)session.getAttribute("editentrycontent");
                        out.println(entrycontent);    
                        %>    
                        </textarea>
                        <input id="entryauthor" name="idauthor" type="hidden" value="<%out.print(user.getId());%>"/>
	<br />
