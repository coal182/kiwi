...
<html>
    ...
    <body>
        ...
        "</td><td>"+u.getName()+"<td>"+u.getUsertype()+"</td>"+
                "</td><td id='buttons'><a href='controller?action=deleteuser&iduser="+iduser+"' id='deleteuser'>d</a>"+
                "<a href='controller?action=edituser&iduser="+iduser+"' id='edituser'>e</a></td></tr>");
               }
                       }
                    %>
        </table>		
